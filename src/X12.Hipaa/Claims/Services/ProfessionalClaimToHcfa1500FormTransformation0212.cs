namespace X12.Hipaa.Claims.Services
{
    ...
    /// </summary>
    public class ProfessionalClaimToHcfa1500FormTransformation0212 : ProfessionalClaimToHcfa1500FormTransformation
    {
        ...
        public ProfessionalClaimToHcfa1500FormTransformation0212(string formImagePath) : base(formImagePath)
        {
        ...
        public override List<FormPage> TransformHcfa1500ToFormPages(HCFA1500Claim hcfa)
        {
            ...
            for (int i = 0; i < hcfa.Field24_ServiceLines.Count; i++)
            {
                if (i % 6 == 0)
                {
                    ...
                    AddBlock(page, 3.9m, 6.6m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsMedicare));
                    AddBlock(page, 11, 6.9m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsMedicaid));
                    AddBlock(page, 18.1m, 6.9m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsTricareChampus));
                    AddBlock(page, 26.7m, 6.9m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsChampVa));
                    AddBlock(page, 34, 6.9m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsGroupHealthPlan));
                    AddBlock(page, 42, 6.9m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsFECABlkLung));
                    AddBlock(page, 47.8m, 6.9m, 2, ConditionalMarker(hcfa.Field01_TypeOfCoverageIsOther));
                    ...
                    AddBlock(page, 34.2m, 9.1m, 3, hcfa.Field03_PatientsDateOfBirth.Month);
                    ...
                    AddBlock(page, 36.2m, 11.2m, 2, ConditionalMarker(hcfa.Field06_PatientRelationshipToInsuredIsSelf));
                    AddBlock(page, 41, 11.2m, 2, ConditionalMarker(hcfa.Field06_PatientRelationshipToInsuredIsSpouseOf));
                    AddBlock(page, 45.6m, 11.2m, 2, ConditionalMarker(hcfa.Field06_PatientRelationshipToInsuredIsChildOf));
                    AddBlock(page, 50.2m, 11.2m, 2, ConditionalMarker(hcfa.Field06_PatientRelationshipToInsuredIsOther));
                    ...
                    AddBlock(page, 38.25m, 19.05M, 2, ConditionalMarker(hcfa.Field10a_PatientConditionRelatedToEmployment));
                    AddBlock(page, 44, 19.05M, 2, ConditionalMarker(!hcfa.Field10a_PatientConditionRelatedToEmployment));
                    ...
                    AddBlock(page, 72m, 19.65m, 2, ConditionalMarker(hcfa.Field11a_InsuredsSexIsMale), TextAlign.center);
                    AddBlock(page, 78.8m, 19.65m, 2, ConditionalMarker(hcfa.Field11a_InsuredsSexIsFemale), TextAlign.center);
                    ...
                    AddBlock(page, 38.25m, 21.5m, 2, ConditionalMarker(hcfa.Field10b_PatientConditionRelatedToAutoAccident));
                    AddBlock(page, 44, 21.5m, 2, ConditionalMarker(!hcfa.Field10b_PatientConditionRelatedToAutoAccident));
                    AddBlock(page, 48, 21.5m, 2.5m, hcfa.Field10b_PatientConditionRelToAutoAccidentState);
                    ...
                    AddBlock(page, 38.25m, 23.8m, 2, ConditionalMarker(hcfa.Field10c_PatientConditionRelatedToOtherAccident));
                    AddBlock(page, 44, 23.8M, 2, ConditionalMarker(!hcfa.Field10c_PatientConditionRelatedToOtherAccident));
                    AddBlock(page, 54, 23.7M, 30, hcfa.Field11c_InsuredsPlanOrProgramName);

                    // LINE 10
                    AddBlock(page, 4, 25.55m, 28.5m, hcfa.Field09d_OtherInsuredsInsurancePlanNameOrProgramName);
                    AddBlock(page, 33.5m, 25.55M, 20, hcfa.Field10d_ReservedForLocalUse);
                    AddBlock(page, 55, 25.8m, 2, ConditionalMarker(hcfa.Field11d_IsThereOtherHealthBenefitPlan));
                    AddBlock(page, 59.8M, 25.8m, 2, ConditionalMarker(!hcfa.Field11d_IsThereOtherHealthBenefitPlan));
                    ...
                    //{
                    AddBlock(page, 5, 31.25M, 3, hcfa.Field14_DateOfCurrentIllnessInjuryOrPregnancy.Month);
                    AddBlock(page, 8, 31.25M, 3, hcfa.Field14_DateOfCurrentIllnessInjuryOrPregnancy.Day);
                    AddBlock(page, 11.3M, 31.25M, 3, hcfa.Field14_DateOfCurrentIllnessInjuryOrPregnancy.Year);
                    //}
                    ...
                    // Field 18
                    AddBlock(page, 58.5m, 33.4M, 3, hcfa.Field18_HospitalizationDateFrom.Month);
                    AddBlock(page, 61.5m, 33.4M, 3, hcfa.Field18_HospitalizationDateFrom.Day);
                    AddBlock(page, 64.5m, 33.4M, 3, hcfa.Field18_HospitalizationDateFrom.Year);
                    ...
                    AddBlock(page, 55m, 35.5m, 2, ConditionalMarker(hcfa.Field20_OutsideLab));
                    AddBlock(page, 59m, 35.5m, 2, ConditionalMarker(!hcfa.Field20_OutsideLab));
